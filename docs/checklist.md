...
#### Building code
* The future solar system should be less than 18" above roof surface.
* The future solar system should be less than highest roof pitch.

#### Flat roof
* Identify mounting methods for solar system (rack or ballast).
* If rack, design and provide with supporting bases in advance (intervention with membrane).
* If ballast, assess how to carry heavy materials to the roof.
* If ballast, conduct structural engineering about the deadload for the future solar system (at least additional 6 lbs/ sqft).
* Identify fall protection measures around edges.

#### Sloped roof
* If it is steep metal roof, conduct a study about snow collection on the roof.
* Identify slip hazard with respect to the roof material.
* Assess how to walk around the roof.
...
#### Compositions
* Check the durability with respect to the expected time to install solar system.
* Design and provide with supporting bases such as flashings in advance (penetrations).

#### Metal
* To avoid heatstroke of installers in summer, avoid reflected materials.
* Match the lip size with the standard of clamps of the solar system.

#### Others (tile, shake, TPO, etc.)
* Try to avoid vulnerable materials to the solar system installation.
...
| Features            | Items                              | Safety | Applicability | Cost-effectiveness |
| ------------------- | ---------------------------------- | ------ | ------------- | ------------------ |
| Solar zone          | Several zones over 80 sqft         |        |               |                    |
|                     | One continuous zone                |        |               |                    |
| Solar zone material | Tile or shake                      |        |               |                    |
|                     | Compositions                       |        |               |                    |
|                     | Metal (standing seam)              |        |               |                    |
|                     | Others (TPO,etc.)                  |        |               |                    |
| Pitch               | Flat                               |        |               |                    |
|                     | Lower slop (4/12)                  |        |               |                    |
|                     | Moderate slop (8/12)               |        |               |                    |
|                     | Steep sloe (over 8/12)             |        |               |                    |
| Fall protection     | Hitch clip (anchor)                |        |               |                    |
|                     | Roof bracket (standing seam)       |        |               |                    |
|                     | Lifeline                           |        |               |                    |
|                     | Others (guardrail,snow guard,etc.) |        |               |                    |
| Access              | Scaffolding                        |        |               |                    |
|                     | Ladder                             |        |               |                    |
|                     | Mechanical lift                    |        |               |                    |
