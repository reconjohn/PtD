...
### Code requirements
  ...
  * Load to be designed with PV over 4 lb/ sq - Seattle residential code
...
* Composition is poor in maintenance and involving moss growth if in rainy climate.
* Composition incurs reinstallation of the solar system, costing about 25% of the initial cost.

### Metal
* Consider metal for durability (about 50 to 100 years).
...
### Low-slop roof: OSHA defines a "low-slope roof" as a roof having a slope of less than or equal to 4 inches of vertical rise for every 12 inches horizontal length (4:12) (1926.500(b)—definitions). This is important because the OSHA definition is used as a basis for implementing low-slope fall-protection measures, such as warning line systems and safety monitors.
...
* Identify fall protection measures around hip, valley, eave and edge (e.g., guardrail).
...
* Consider additional options (e.g., setback, snow guard, guardrail and so on).
