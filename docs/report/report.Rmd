...
kable(data, format = "latex", caption = "List of interviews", booktabs = T) %>%
...
```{r fig.height= 8, fig.width= 12, fig.cap= "Survey results"}
g_ov_sur
```
...
```{r fig.show='hold', fig.cap= "Case studies 1 and 2"}
knitr::include_graphics(c("../case/case1/google.png","../case/case2/google.png"),
                        dpi= c(225,210))
```

```{r fig.show='hold', fig.cap= "Case studies 3 and 4"}
...
kable(data, format = "latex", caption = "Summary of case studies", booktabs = T) %>%
