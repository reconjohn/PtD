...
<center>
```{r fig.show='hold', fig.cap= "Case Studies 1 and 2 (Google map accessed in Mar. 2019)"}
knitr::include_graphics(c("../case/case1/google.png","../case/case2/google.png"),
                        dpi= c(225,210))
```

```{r fig.show='hold', fig.cap= "Case Studies 3 and 4 (Google map accessed in Mar. 2019)"}
...
<center>
```{r fig.show='hold', fig.cap= "Solar panels on roof of case studies 2 and 4"}
