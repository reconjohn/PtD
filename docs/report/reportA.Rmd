...
knitr::include_graphics(c("../case_studies/case1/google.png","../case_studies/case2/google.png"),
                        dpi= c(225,210))
```

```{r fig.show='hold', fig.cap= "Case Studies 3 and 4 (Google map accessed in Mar. 2019)"}
knitr::include_graphics(c("../case_studies/case3/google.png","../case_studies/case4/google.png"),
                        dpi= c(223,190))
```
...
data <- read_excel("../case_studies/compare.xlsx", sheet = 1,col_names = TRUE)[2:6][1:22,]
# View(data)
...
knitr::include_graphics(c("../case_studies/case2/dwelldevelopmentsolar2.jpg","../case_studies/case4/ColorOH.png"),
                        dpi= c(500,400))
```
</center>
